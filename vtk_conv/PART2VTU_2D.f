...
c       initial data for SPH models                                                                     72
      ...
      parameter(np_max = 999999,i_PART_counter_max=20000)
...
c     %LOAD AND READ TIME,DT FROM FILE DT. THE FIRST HEADERLINE IN 
        open(unit=70,file='../data_out/uv/time_out',status='old')
        i_loop_finish = 0
        i_PART_counter = 0
